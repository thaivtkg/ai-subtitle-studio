...
def get_whisper_model(model_size, compute_type):
    ...
    import torch  # Lazy import torch
    from faster_whisper import WhisperModel  # Lazy import faster-whisper
...
def burn_hardsub(video_path, srt_path, output_path, font_size=42, font_color="white", font_name="Arial", progress_callback=None, log_callback=None, process_callback=None):
    """
    Hàm chèn hardsub vào video. Tự động ép định dạng đầu ra thành MP4 để tránh lỗi màn hình đen.
    """
    # 1. ÉP BẮT BUỘC ĐUÔI FILE ĐẦU RA THÀNH .MP4
    ...
    try:
        ...
        # Chỉ tắt tiến trình nếu nó bị treo hoặc người dùng bấm Cancel
